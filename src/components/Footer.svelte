<footer id="footer" class="py-20 sm:py-32 bg-bllack border-t border-solid
border-violet-950 flex flex-col gap-4 sm:gap-8 justify-center items-center">
    ...
    <div class="flex flex-col gap-4 items-center justify-center">
        <p><b class="pr-2">Email</b>harshitchauhan2233@gmail.com</p>
        <p><b class="pr-2">LinkedIn</b>
            <a class="text-violet-400" target="_blank" href="https://www.linkedin.com/in/harshit-chauhan-00b4311b7/">
                Harshit Chauhan<sup
